...
export default function Header() {
  const pathname = usePathname(); const router = useRouter(); const { cartCount, total, user } = useAppStore();
  ...
  return <>
    <div className="announcement"><div className="container announcement-inner"><span><span className="announcement-dot" /> Free delivery on orders over Rs. 5,000</span><span className="announcement-right">Open daily 8:00 AM - 8:00 PM</span></div></div>
    <header className="site-header"><div className="container header-inner">
      ...
      <Link className="brand" href="/" onClick={() => setMenuOpen(false)}><span className="brand-mark"><ShoppingBag size={20} /></span><span><strong>Nova<span>Mart</span></strong><small>Everything you need, delivered</small></span></Link>
